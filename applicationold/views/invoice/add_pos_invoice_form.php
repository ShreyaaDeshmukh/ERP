                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        $date = date('Y-m-d');
                                        ?>
                                        <input class="form-control" type="text" size="50" id="invoice_date" name="invoice_date" required value="<?php echo $date; ?>" required/>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        <td align="center">
                                            ...
                                            <input type="button" id="" class="btn btn-warning" name="" value="<?php echo display('full_paid') ?>" tabindex="12" onClick="full_paid();"/>
                                        </td>
