...
// $all_product = $CI->Purchases->all_product_list();
?>
			...
			<div class="panel panel-default">
				...
				<div class="col-sm-2">
					...
					<div class="col-sm-2" hidden>
						<input type="text" class="form-control" style="width:100%" placeholder="Search By Customer PO" name="customer_po" id="customer_po" value="<?php echo @$_POST['customer_po']?>">
					</div>
                            ...
                            <table id="dataTableExample3" class="table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <center>
										...
										<a href="<?php echo base_url() . 'Cticket?supplier_id={supplier_id}&product_id={product_id}'; ?>" class="btn btn-warning btn-sm" data-toggle="tooltip" data-placement="left" title="Add ticket"><i class="fa fa-barcode" aria-hidden="true"></i></a> 
