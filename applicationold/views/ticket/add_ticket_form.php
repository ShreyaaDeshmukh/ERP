            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <?php echo form_open_multipart('Cticket/insert_ticket',array('class' => 'form-vertical', 'id' => 'insert_purchase','name' => 'insert_purchase', 'onsubmit' => 'return checkAllValues()'))?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                       <select name="customer_id" id="customer_sss" class="form-control dont-select-me" onchange="getCustomerNameAddress(this.value)" required> 
                                    ...
                                    <div class="col-sm-6 shipTo">
                                       <div class="maintextarea">
										...
										<!-- <select name="multipleAddress" id="multipleAddress" multiple="multiple">
											...
											<select name="ship_to[]" id="multipleAddress" class="form-control" required="true"  multiple="multiple"> 
						...
						<div class="row">
							<div class="col-md-2">
								<label><?php echo "C or S";?></label>
							</div>
							<div class="col-md-4">
								
								
								<label class="radio-inline typeflag"><input id="stockflag" type="radio" name="optradio"   value="s" onchange="checkthetypeflag(this.value, this);">S</label>
								<label class="radio-inline typeflag"><input id="customerflag" type="radio" name="optradio"  value="c" checked onchange="checkthetypeflag(this.value, this);">C</label>
	...
	$(document).ready(function(){
		...
		/* $.ajax
            ...
            success: function (data){
				...
				getCustomerNameAddress(customerid);
				pt();
