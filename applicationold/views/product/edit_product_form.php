        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <?php echo form_open_multipart('Cproduct/product_update/'.$r_id, array('class' => 'form-vertical', 'id' => 'product_update', 'name' => 'product_update', 'onsubmit' => 'return checkValidation()')) ?>
...
//                                            }
						...
						<div class="row">
							...
							<div class="col-md-2">
								<label class="switch">
								  <input tabindex='7'  onclick="checkSerialFlag(this);" type="checkbox" value="1" name="serial_flag"  <?php if($serial_flag==1){?> checked <?php }?><?php if($lot_exp_serial_flag==1){?> disabled="disabled" <?php }?>>
								  <span class="slider round"></span>
								</label>
							</div>
						</div>
						...
						// echo "tapan ".$serial_flag; die;
						/* print_r($arrayUnits); */
						/* $arrayUnits = array_keys($unit); */
						#if($i==0){
						?>
						<div class="row">
							<!-- comment by tapan on 20-05-2019 -->
						
							<?php // if(!empty($unit) && @$unit['sell_price']!='' && @$unit['vendor_price']!=''){ ?>
						
						<?php if(!empty($unit)){?>
						
						<?php  if($serial_flag == 0) {?>
							<div class="unitbunch">
						<?php }else{ ?>
						...
						<?php
							...
							<div class="col-md-1 showPlsu">
								<span class="glyphicon glyphicon-plus plusicon"></span>
							</div>
							<?php } else{
								if($serial_flag==0){
								?>
							<div class="col-md-1 showPlsuM">
						...
						<!-- <div class="unitbunch1" style="display:none;"></div> -->
...
function checkSerialFlag(thisone){
	...
	if(checkprop==true){
		...
		$(".addmore").hide();
		$(".addmore").html('');
		$(".unitbunch").html(''); // add by tapan  20-05-2019
		$(".unitbunch").hide();
		/* $(".plusicon").html('');
		$(".minusicon").html(''); */
		$(".minusicon").css("display", "none");
		$(".plusicon").css("display", "none");
		$(".showPlsu").css("display", "none");
		
		$(".unitbunch").attr("disabled", "disabled");
		$(".addmore").attr("disabled", "disabled");
		
var myvar = '<div class="newhtml row"><div class="col-md-2 form-group">'+
'									<div class="input-group">'+
'									<select name="first[]" class="form-control dont-select-me firstdd1 perFrom" tabindex=\'9\'>'+
'										<option value="">Select</option>'+
'										<option value="EACH">Each</option>'+
...
$(".unitbunch1").html(myvar);
		...
		$(".addmore").show();
		 $(".addmore").html('');
		$(".unitbunch1").hide();
		$(".unitbunch1").attr("disabled", "disabled");
		/* $(".unitbunch1").attr("disabled", "disabled"); */
		$(".unitbunch").attr("disabled", false);
		...
		$(".addmore").html('<div class="newhtml row"><div class="col-md-2 form-group"><div class="input-group"><select name="first[]" class="form-control dont-select-me firstdd perFrom" tabindex="9">	<option value="">Select</option>	<option value="EACH">Each</option>	<option value="INNER_CART">Inner-Carton</option>	<option value="CARTON">Carton</option>	<option value="PALLET">Pallet</option></select><input type="number" value="1" min="1" name="firstval[]" class="form-control pertoqty0" readonly="true" tabindex="10"></div><div class="vl"></div></div><div class="col-md-2 form-group"><div class="input-group"><select name="second[]" class="form-control dont-select-me seconddd perTo" tabindex="11">	<option value="Select">Select</option>	</select><input type="number" value="1" min="1" name="secondval[]" class="form-control pertoqty" tabindex="12"><div class="vl1"></div></div></div><div class="col-md-2 form-group"><div class="input-group"><select name="third[]" class="form-control dont-select-me thirddd perTo1" tabindex="13">	<option value="Select">Select</option>	</select><input type="number" value="1" min="1" name="thirdval[]" class="form-control pertoqty1" tabindex="14"><div class="vl1"></div></div></div><div class="col-md-2 form-group"><div class="input-group"><select name="fourth[]" class="form-control dont-select-me fourthddd perTo1" tabindex="15">	<option value="Select">Select</option>	</select><input type="number" value="1" min="1" name="fourthval[]" class="form-control pertoqty2" tabindex="16"><div class="vl1"></div></div></div><div class="col-md-1 form-group" style="width:9%;"><div><b>Sell Price</b></div><div><input type="number" value="" min="1" name="sell_price[]" class="form-control totals" required  tabindex="17" step="0.01"></div></div><div class="col-md-1 form-group" style="width:12%;"><div><b>Vendor Price</b></div><div><input type="number" value="" min="1" name="vendor_price[]" class="form-control vendor_price" required  tabindex="18" step="0.01"></div></div><div class="col-md-1"><span class="glyphicon glyphicon-plus plusicon"></span></div></div>');
		$(".unitbunch").show();
		$(".unitbunch1").hide();
