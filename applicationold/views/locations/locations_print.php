...
<div class="content-wrapper">
    ...
    height:100%;">
                                            ...
                                            <div><?php echo "<p>". $user['location_name']."</p>";?></div>
                                            <div>
                                                <img src="<?php echo base_url('Cbarcodelocation/barcode_generator/'.$user['location_unique_key'])?>" class="img-responsive center-block" alt="" style="display: block;margin-left: auto;margin-right: auto; height: 58px;">
                                            </div>  
