<!-- Change Password Page Start --><style>#email-error{	position: absolute;    left: 0;    margin-top: 40px;}#old_password-error{	position: absolute;    left: 0;    margin-top: 40px;}#password-error{	position: absolute;    left: 0;    margin-top: 40px;}#repassword-error{	position: absolute;    left: 0;    margin-top: 40px;}</style>
                        ...
                        <div class="panel-heading">
                         ...
                         <?php echo form_open_multipart('Admin_dashboard/change_password',array('id' => 'insert_product','class' => 'form-horizontal'))?>
                            <div class="panel-body">
                                ...
                                <label for="login-email" style="width:100%;"><?php echo display('email') ?></label>
                                ...
                                <label for="login-email" style="width:100%;"><?php echo display('old_password') ?></label>
                                <div class="input-group">
                                ...
                                <label for="login-email" style="width:100%;"><?php echo display('new_password') ?></label>
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                                ...
                                <label for="login-email" style="width:100%;"><?php echo display('re_type_password') ?></label>
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                            ...
                            <div class="panel-footer text-center">
                                <div class="login-btn">
                                    <button type="submit" class="btn btn-success btn-block m-b-10"><?php echo display('change_password') ?></button>
                                </div>             
                            </div>
                        <?php echo form_close()?>
                    </div>
