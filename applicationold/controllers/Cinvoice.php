		...
		if (!empty($product_details)){
			...
			$tr .= "<tr id=\"row_".$product_id."\">
						...
						<td>
                       	...
                       	<td>
                            <input type=\"number\" name=\"cartoon[]\" onkeyup=\"quantity_calculate('".$product_id."');\" onchange=\"quantity_calculate('".$product_id."');\" class=\"quantity_".$product_id." form-control text-right\" value=\"0\" min=\"1\" required/>
                        </td>
                        <td>
