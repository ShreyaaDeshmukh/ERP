...
<body class="login-page">
  <div class="login-box">
   ...
   <?php 
        ...
        <?php } ?>
        <form action="<?php echo base_url(); ?>Admin_dashboard/do_login" method="post">
        ...
        <!-- <a href="<?php echo base_url() ?>Admin_dashboard/signup">Create new account</a> -->
      

      
        <a href="<?php echo base_url() ?>Admin_dashboard/PricingPlan">Create new account</a>
