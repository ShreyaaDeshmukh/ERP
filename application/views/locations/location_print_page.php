                    ...
                    <div class="panel-body">
						...
						?>
							<div style="float: center">
								...
								<a  class="btn btn-danger" href="<?php echo base_url('Clocation/manage_location');?>"><?php echo display('cancel')?></a>
							</div>
						<?php
						}
						?>
							...
							?>
								<div id="printableArea">
									...
									<div class="col-md-12">
											...
											<div>&nbsp;</div>
											<div>
												<img src="<?php echo base_url('Cbarcodelocation/barcode_generator/'.$labnum['location_unique_key'])?>" class="img-responsive center-block" alt="" style="display: block;margin-left: auto;margin-right: auto;">
											</div>	
											<div>&nbsp;</div>
										</div>
									</div>	
