                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" tabindex="2" class="form-control" name="first_name" value="{first_name}"  placeholder="<?php echo display('first_name') ?>" maxlength="20" required />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" tabindex="3" class="form-control" name="last_name" value="{last_name}"  placeholder="<?php echo display('last_name') ?>" maxlength="20" required />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" tabindex="3" id="email" class="form-control" name="email" value="{email}"  placeholder="<?php echo display('email') ?>" required />
                            </div>          
                        </div>
                        <div class="form-group row">
                            <label for="Mobile" class="col-sm-3 col-form-label">Mobile <i class="text-danger">*</i></label>
                            <div class="col-sm-6">
                                <input type="text" tabindex="3" id="email" class="form-control" name="mobile" value="{mobile}"  placeholder="<?php echo display('email') ?>" required />
                            </div>
                        </div>
