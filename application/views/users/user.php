...
//                                            echo '<pre>';    print_r($user_list);die();
                                        ...
                                        <center>
                                            ...
                                            // print_r($user["id"]);die;
                                            ?>
                                            <a href="<?php echo base_url('User/user_update_form/' . $user["id"]); ?>" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" title="" data-original-title="<?php echo display('update') ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>
