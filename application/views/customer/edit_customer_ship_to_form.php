        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                  ...
                  <?php echo form_open_multipart('Ccustomer/customer_ship_to_update',array('class' => 'form-vertical', 'id' => 'customer_update'))?>
                    <div class="panel-body">

                    	<div class="form-group row">
                            <label for="customer_name" class="col-sm-3 col-form-label"><?php echo display('customer_name') ?> <i class="text-danger">*</i></label>
                            <div class="col-sm-6">
                                <input class="form-control" name ="customer_name" id="customer_name" type="text" placeholder="<?php echo display('customer_name') ?>"  required="" value="{customer_name}" tabindex='1' readonly >
                            </div>

                        </div>

                        <div class="form-group row">
                            <label for="customer_name" class="col-sm-3 col-form-label">Ship To Name<i class="text-danger">*</i></label>
                            <div class="col-sm-6">
                                <input class="form-control" name ="ship_to_name" id="ship_to_name" type="text" placeholder="Ship To Name"  required="" value="{ship_to_name}" tabindex='1'>
                            </div>

                        </div>
   
                       	<div class="form-group row">
                            <label for="email" class="col-sm-3 col-form-label">Ship To Email<i class="text-danger">*</i></label>
                            <div class="col-sm-6">
                                <input class="form-control" name ="ship_to_email" value="{ship_to_email}" id="ship_to_email" type="email" placeholder="Ship To Email" tabindex='2' required>
                            </div>
                        </div>

                        <div class="form-group row">
                            <label for="mobile" class="col-sm-3 col-form-label">Ship To Mobile<i class="text-danger">* eg. 111-111-2222</i></label>
                            <div class="col-sm-6">
                                <input class="form-control" name ="ship_to_phone" value="{ship_to_phone}" id="ship_to_phone" type="text"  maxlength="12" minlength="12" placeholder="Ship To Mobile"  tabindex='3' required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label for="address " class="col-sm-3 col-form-label">Ship To Address*</i></label>
                            <div class="col-sm-6">
                                <textarea class="form-control" name="ship_to_address" id="ship_to_address " rows="3" placeholder="Ship To Address" tabindex='8' required>{ship_to_address} </textarea>
                            </div>
                        </div>	
					...
					<!-- <div class="form-group row">                            
						...
						<input class="form-control" name="customer_detail" id="customer_detail" type="text"  value="{customer_detail}" placeholder="<?php echo "Customer Detail" ?>" tabindex='9'>                            
						</div>                        
						</div>	 -->
