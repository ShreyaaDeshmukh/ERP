                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                       <select name="customer_id" id="customer_sss" class="form-control" required="true"  onchange="getCustomerNameAddress(this.value,0)"> 
                               ...
                               <div class="row">
                                    ...
                                    <div class="col-md-8" style="margin-left:89px;">
										...
										<!-- <select name="multipleAddress" id="multipleAddress" multiple="multiple">
											...
											<select name="ship" id="multipleAddress" class="form-control" required="true" onchange="getShipAddress(this.value)" multiple="multiple"> 
...
<script type="text/javascript">
   ...
   // Product selection start
	...
	function checkCustomePO(value){
		console.log(value);
        console.log("mil gaya",$("#customer_sss").val());
       
        var customer_id = $("#customer_sss").val();
		$.ajax
				({
					url: "<?php echo base_url('Cpurchase/checkCustomePO')?>",
					data: {customer_po:value, customer_id: customer_id},
					type: "post",
					success: function(data)
					{
						var obj = JSON.parse(data);
