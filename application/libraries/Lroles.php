...
class Lroles {
    ...
    public function user_list() {
        ...
        $userList = $CI->parser->parse('roles', $data, true);
    ...
    public function user_add_form() {
        ...
        $data = array(
            ...
            'title' => 'Add user',
            'admin_username'=>$CI->session->userdata('username'),
        );
        // $CI = & get_instance();
        // print_r($data);exit;
    ...
    public function user_view_role($user_id) 
    {
        $CI = & get_instance();
...
//        );
      ...
      //echo '<pre>';        print_r($data1);die();
        ...
        $companyList = $CI->parser->parse('view_roles', $data1, true);

        return $companyList;

    }

    public function user_update_role($user_id) 
    {
        $CI = & get_instance();
...
//        );
      ...
      //echo '<pre>';        print_r($data1);die();
        ...
        $companyList = $CI->parser->parse('update_roles', $data1, true);
