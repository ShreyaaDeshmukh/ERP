...
class Lpurchase {
	...
	public function purchase_details_data($purchase_id)
	{
		...
		$purchase_detail1 = $CI->Purchases->purchase_details_data($purchase_id);
		#echo "<pre>";print_r($purchase_detail);die;
		$purchase_detail = $purchase_detail1[0];
		...
		if($purchase_detail1[1]){
			...
			$data=array(
				...
				'ship_to_name' => $purchase_detail[0]['ship_to_name'],
				'customer_zip' => '',
			...
			$data=array(
				...
				'customer_name'		=>	$purchase_detail[0]['customer_name'],
				'customer_address' => $purchase_detail[0]['customer_address'],
				'ship_to_name' => $purchase_detail[0]['customer_name'],
